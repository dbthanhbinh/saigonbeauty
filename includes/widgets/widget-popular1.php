...
class ws24h_popular_widget extends WP_Widget
{
	...
	function __construct() {
		parent::__construct(
			...
			__( 'Widget Ws24h Post', WS24H_THEME_NAME ), // Name
			array( 'description' => __( 'A Ws24h Post Widget', WS24H_THEME_NAME ), ) // Args
		);
	}
	...
	public function form( $instance ) {
        ...
        <p>
			...
			<label for="<?php echo $this->get_field_id( 'cats_id' ); ?>"><?php echo  __('Category : (keep Ctrl and choosen multiple)',WS24H_THEME_NAME); ?></label>
        ...
        <p>
			<label for="<?php echo $this->get_field_id( 'latest' ); ?>"><?php echo __('Latest news:',WS24H_THEME_NAME);?> </label>
        ...
        <p>
			<label for="<?php echo $this->get_field_id( 'excerpt_len' ); ?>"> <?php echo __('Excerpt Len to show:',WS24H_THEME_NAME);?> </label>
        ...
        <p>
			<label for="<?php echo $this->get_field_id( 'excerpt_hidden' ); ?>"><?php echo __('Hidden excerpt:',WS24H_THEME_NAME);?> </label>
        ...
        <p>
			<label for="<?php echo $this->get_field_id( 'no_of_posts' ); ?>"> <?php echo __('Number of posts to show:',WS24H_THEME_NAME);?> </label>
        ...
        <p>
			<label for="<?php echo $this->get_field_id( 'thumb' ); ?>"><?php echo __('Display Thumbnail:',WS24H_THEME_NAME);?> </label>
        ...
        <p>
			<label for="<?php echo $this->get_field_id( 'thumb_full' ); ?>"><?php echo __('Thumbnail Full:',WS24H_THEME_NAME);?> </label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'datetime' ); ?>"><?php echo __('Display date:',WS24H_THEME_NAME);?> </label>
        ...
        <p>
			<label for="<?php echo $this->get_field_id( 'comment' ); ?>"><?php echo __('Display comment:',WS24H_THEME_NAME);?> </label>
        ...
        <p>
			<label for="<?php echo $this->get_field_id( 'color_full' ); ?>"><?php echo __('Title full color:',WS24H_THEME_NAME);?> </label>

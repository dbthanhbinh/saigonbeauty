				...
				<div class="wrapper">
					<div class="ms-cols-12">	
						...
						<div class="ms-cols-6">
							...
							<div class="f-info" style="margin-top: 12px;">
								<h5> <?php echo tie_get_option('text_contact_company_name');?> </h5>
								<p>
									<?php echo tie_get_option('text_contact_company_address');?>
								</p>
								<p>
									<strong>Điện thoại:</strong> <?php echo tie_get_option('contact_company_phone');?>
								</p>
								<p>
									<strong>Email:</strong> <?php echo tie_get_option('contact_email');?>
								</p>
							</div>
						</div>
						<div class="ms-cols-5">
				...
				<div class="wrapper">
					<div class="ms-cols-12">
						<div class="site-copyright">
							© Doanhnhanvanhoa.com 2015. All Rights Reserved.
						</div>

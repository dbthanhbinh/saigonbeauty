...
<div class="mo-panel">
	...
	<form action="/" name="tie_form" id="tie_form">
		...
		<div id="tab8" class="tab_content tabs-wrap">
            ...
            <div class="tiepanel-item">
				<h3>Left Right Banner slider</h3>
				<?php
				tie_options(				
					array(	"name" => "Enable Left Right Banner",
							"id" => "left-right-banner-slider",
                            "extra_text"     => "Check enable display Left Right Banner in sidebar left-right website: Setting Left-Right Banner -> Click here: <a href='".get_bloginfo('url')."/wp-admin/widgets.php' target='_blank'> Setting L-R Banner widgets</a>",
							"type" => "checkbox")); 
				?>
			</div>
